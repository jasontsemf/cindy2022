  ...
  $(function() {
    ...
    return $("tr").click(function() {
      if ($(this).attr('data-title') === "weGrew") {
        ...
        $(".band").css({"background": "url(https://jasontsemf.github.io/cindy2022/assets/我們都是這樣長大的.jpg)  center no-repeat", "background-position": "center"});
        window.duration = 270;
        setInterval(updateSlider, 100);
        ...
        $(".band").css({"background": "url(https://jasontsemf.github.io/cindy2022/assets/誰令你心痴.jpg)  center no-repeat", "background-position": "center"});
        window.duration = 302;
        setInterval(updateSlider, 100);
